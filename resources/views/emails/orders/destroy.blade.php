<x-mail::message>
    ...
    <p>Đơn hàng #{{$data['order']->id}} của bạn đã bị hủy vào ngày {{$data['order']->verified_at }}.</p>
    <p>Chúng tôi chân thành xin lỗi về vấn đề này, bạn có thể liên hệ qua đường dây nóng 0888.928.444 để biết thêm chi tiết</p>
