        ...
        <div class="page-breadcrumb bg-white">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    @if($approve)
                        <h4 class="page-title">Danh sách đơn hàng đang vận chuyển</h4>
                    @else
                        <h4 class="page-title">Danh sách đơn hàng chờ xác nhận</h4>
                    @endif
                </div>
            </div>
            <!-- /.col-lg-12 -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="txt-oflo">
                                            <div>
                                                ...
                                                @if(!$approve && !$order->pay)
                                                    <form action="{{route('admin.order.delete', [$order->id])}}" method="post" class="d-inline-block">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-danger btn-sm" type="submit"
                                                                onclick="return confirm('Bạn có thực sự muốn hủy?');">
                                                            Hủy
                                                        </button>
                                                    </form>
                                                @endif
