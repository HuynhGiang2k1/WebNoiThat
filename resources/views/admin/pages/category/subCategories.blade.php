        ...
        <div class="page-breadcrumb bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">THÊM MỚI DANH MỤC PHỤ</h4>
                </div>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="card" style="width: 500px; height: max-content; margin-left: 20px;">
                ...
                <div class="card-body">
                    <form action="{{route('admin.subcategories.store')}}" method="post" enctype="multipart/form-data">
                        <div class="mt-2">
                            <lable style="margin-bottom: 8px; display: inline-block;">Tên danh mục phụ:</lable>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{route('admin.subcategories.delete', $category->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('admin.subcategories.update')}}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="category-name"
                                               class="col-form-label">Thuộc danh mục:</label>
                                        <select class="form-select" aria-label="Default select example" name="category_id">
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}">{{$category->name}}
                                                </option>
